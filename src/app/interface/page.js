            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <h2>
                    {" "}
                    Browse High-Quality <br />
                    Icons by Category{" "}
                  </h2>
                  <p className="col-lg-8 mt-3">
                    {" "}
                    The largest database of vector icons available for download SVG,
                    EPS, PSD and BASE 64 formats.{" "}
                  </p>
                </div>
                {/* <div className="col-lg-6">
                      ...
                      <div className="row row-cols-1 row-cols-lg-2 align-items-center">
                        <div className="col">
                          <div className="ab-left">
                            ...
                            <p className="col-lg-8 mt-3">
                              {" "}
                              We’ve developed from scratch our tools to browse,
                              customize and quickly use our assets. Drop our icons
                              and illustration right into your workflow.{" "}
                            </p>
                            <Link href="" className="btn btn-explore mt-2">
                              Explore now
                            </Link>
                          </div>
                        </div>
