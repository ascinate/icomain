            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                ...
                <p className="col-lg-8 mt-3">
                  {" "}
                  The largest collection of hand-crafted interface icons
                  available in SVG, PNG, EPS, PSD, and IconFont formats.{" "}
                </p>
          ...
          <main className="pricing-pages-part interface-bgs float-start w-100">
            ...
            <section className="float-start about-sections-features01 comon-short-parts w-100 pb-0">
              <aside className="container">
                <h2 className="comon-head"> Why Choose IconsGeek? </h2>
                  ...
                  <div className="col">
                    <div className="comons-cardscus new-heights min-heights015 d-inline-block w-100">
                      <div className="text-div015 d-inline-block w-100">
                        ...
                        <p>
                          {" "}
                          All icons are meticulcusly designed to be
                          pixel-perfect.{" "}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col">
                    <div className="comons-cardscus new-heights min-heights015 d-inline-block w-100">
                      <div className="text-div015 d-inline-block w-100">
                        ...
                        <p>
                          {" "}
                          Easily change colors, size and stroke widtts to suit
                          your needs.{" "}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col">
                    <div className="comons-cardscus new-heights min-heights015 d-inline-block w-100">
                      <div className="text-div015 d-inline-block w-100">
                        ...
                        <p>
                          {" "}
                          Download icons in SVG, PNG, EPS, PSD, and IconFont
                          formats.{" "}
                        </p>
                      </div>
                    </div>
