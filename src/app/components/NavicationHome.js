       ...
       <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container">
                ...
                <div className="right-menus-div01 ms-auto d-flex align-items-center">
                     ...
                     <Link href='https://www.instagram.com/iconguru_official/' className="btn home01-links" target="_blank" role="noopener noreferrer">
                     ...
                     <Link href='https://www.facebook.com/profile.php?id=61575078242862' className="btn home01-links" target="_blank" role="noopener noreferrer">
                     ...
                     <Link href='https://x.com/icons_guru' className="btn home01-links" target="_blank" role="noopener noreferrer">
                     ...
                     <Link href='https://www.linkedin.com/in/icons-guru-27583335b/' className="btn home01-links" target="_blank" role="noopener noreferrer">
